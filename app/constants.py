...
DEFAULT_TRANSACTIONS = [
    ("TechCorp Salary", "Income", "income", 390000, "2026-03-15", "Основной доход"),
    ...
    ("TechCorp Salary", "Income", "income", 395000, "2026-04-15", "Основной доход"),
    ("Beeline Home Internet", "Utilities", "expense", 9600, "2026-04-17", "Интернет"),
    ("TechCorp Salary", "Income", "income", 401000, "2026-05-15", "Основной доход"),
    ("Yandex Taxi", "Transport", "expense", 14500, "2026-05-22", "Поездки по городу"),
    ("TechCorp Salary", "Income", "income", 408000, "2026-06-15", "Основной доход"),
    ("Magnum Supermarket", "Groceries", "expense", 32450, "2026-06-19", "Продукты"),
    ("Freelance Project", "Income", "income", 72000, "2026-07-10", "Дополнительный доход"),
    ("Cinema City", "Entertainment", "expense", 26400, "2026-07-24", "Отдых"),
    ("TechCorp Salary", "Income", "income", 412000, "2026-08-15", "Основной доход"),
